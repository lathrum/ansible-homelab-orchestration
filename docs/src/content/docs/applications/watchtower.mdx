...
Prometheus scrapes `/v1/metrics` on `watchtower_metrics_port` (default `8081`) automatically.
Then import the dashboard from the Watchtower repo's [`examples/metrics/grafana/dashboards/dashboard.json`](https://github.com/nicholas-fedor/watchtower/blob/main/examples/metrics/grafana/dashboards/dashboard.json)
